#### Link download termux : https://f-droid.org/repo/com.termux_118.apk jika sudah di download buka aplikasi nya, lalu install dengan ketikan perintah di bawah ini :
````bash
